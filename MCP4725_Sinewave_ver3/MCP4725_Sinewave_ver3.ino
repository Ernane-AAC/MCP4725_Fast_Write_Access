// ========================================================================================
// MCP4725 - Sine wave generator - VERSION 3 - Library: Wire.h
...
ISR(TIMER1_OVF_vect)
{
 ...
 DA_Wire_Write(sample); //send sample to MCP4725
...
// ========================================================================================
// =========  Write 12-bit sample into MCP4725 using Fast Mode Write Command ==============
void DA_Wire_Write(int sample){ 
  Wire.beginTransmission(MCP4725_Address);
  Wire.write((sample & 0x0FFF) >> 8); //send MSB(command+upper nibble sample)
